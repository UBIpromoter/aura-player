// Question Screen v1: Violet, Cyan, Blue, Green, Rose
import React from 'react';

export default function QuestionScreenV1() {
  return (
    <div className="min-h-screen bg-gray-950 p-4 flex justify-center">
      <div className="w-[390px] rounded-[40px] overflow-hidden relative bg-gray-950 p-6">
        <h2 className="text-white text-lg font-medium mb-6 text-center">V1: Violet, Cyan, Blue, Green, Rose</h2>

        {/* Results - Full Width Bars */}
        <div className="space-y-4">
          {/* Violet */}
          <div className="flex items-center gap-3">
            <span className="text-violet-400 text-lg font-medium w-8">24</span>
          ...
          {/* Blue */}
          <div className="flex items-center gap-3">
            <span className="text-blue-400 text-lg font-medium w-8">19</span>
            <div className="flex-1 h-8 rounded-full overflow-hidden flex">
