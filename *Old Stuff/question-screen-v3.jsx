// Question Screen v3: Fuchsia, Sky, Violet, Cyan, Blue
import React from 'react';

export default function QuestionScreenV3() {
  return (
    <div className="min-h-screen bg-gray-950 p-4 flex justify-center">
      <div className="w-[390px] rounded-[40px] overflow-hidden relative bg-gray-950 p-6">
        <h2 className="text-white text-lg font-medium mb-6 text-center">V3: Fuchsia, Sky, Violet, Cyan, Blue</h2>
        ...
        <div className="space-y-4">
          ...
          {/* Sky */}
          <div className="flex items-center gap-3">
            <span className="text-sky-400 text-lg font-medium w-8">20</span>
            <div className="flex-1 h-8 rounded-full overflow-hidden flex">
          ...
          {/* Violet */}
          <div className="flex items-center gap-3">
            <span className="text-violet-400 text-lg font-medium w-8">19</span>
            <div className="flex-1 h-8 rounded-full overflow-hidden flex">
              <div className="h-full w-[25%] bg-violet-700" />
              <div className="h-full w-[25%] bg-violet-500" />
              <div className="h-full w-[25%] bg-violet-400" />
              <div className="h-full w-[25%] bg-violet-300" />
            </div>
          </div>

          {/* Cyan */}
          <div className="flex items-center gap-3">
            <span className="text-cyan-400 text-lg font-medium w-8">19</span>
            <div className="flex-1 h-8 rounded-full overflow-hidden flex">
          ...
          {/* Blue */}
          <div className="flex items-center gap-3">
            <span className="text-blue-400 text-lg font-medium w-8">18</span>
            <div className="flex-1 h-8 rounded-full overflow-hidden flex">
              <div className="h-full w-[25%] bg-blue-700" />
              <div className="h-full w-[25%] bg-blue-500" />
              <div className="h-full w-[25%] bg-blue-400" />
              <div className="h-full w-[25%] bg-blue-300" />
            </div>
          </div>
        </div>
