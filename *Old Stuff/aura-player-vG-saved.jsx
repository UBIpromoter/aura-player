...
/**
 * Aura Player vE
 * Demo-ready polish: mid-tier user experience, profile access, reset demo
 */
                    ...
                    <button
                      ...
                      style={{
                        background: tappedAnswer === 0
                          ...
                          : undefined,
                        transform: tappedAnswer === 0 ? `scale(${1 + tapCount * 0.015})` : 'scale(1)',
                        boxShadow: tappedAnswer === 0
                          ? `0 0 ${tapCount * 8}px rgba(16, 185, 129, ${0.2 + tapCount * 0.15})`
                          : 'none',
                        filter: tappedAnswer === 0
                          ? `brightness(${darkMode ? 0.85 : 1.0} + ${tapCount * 0.1}) saturate(${0.7 + tapCount * 0.2})`
                          : 'none'
                      }}
                    >
                    ...
                    <button
                      ...
                      style={{
                        background: tappedAnswer === 1
                          ...
                          : undefined,
                        transform: tappedAnswer === 1 ? `scale(${1 + tapCount * 0.015})` : 'scale(1)',
                        boxShadow: tappedAnswer === 1
                          ? `0 0 ${tapCount * 8}px rgba(244, 63, 94, ${0.2 + tapCount * 0.15})`
                          : 'none',
                        filter: tappedAnswer === 1
                          ? `brightness(${darkMode ? 0.85 : 1.0} + ${tapCount * 0.1}) saturate(${0.7 + tapCount * 0.2})`
                          : 'none'
                      }}
                    >
