...
const Q_RAW = [
  ...
  { id:371, v:1, t:'m', c:'j', q:"What's the ideal home temperature?", o:["65-67°F","68-70°F","71-73°F","74-76°F","Varies by room/season"], x:1},
  ...
  { id:444, v:2, t:'m', c:'j', q:"Is pineapple a valid pizza topping?", o:["Absolutely — sweet + savory is elite","Never — it's a crime against pizza","Sometimes — depends on the combo","I don't care enough to have an opinion"] },
  ...
  // === Spicy Takes (456-465) ===
  { id:456, v:1, t:'m', c:'j', q:"Is it ever acceptable to microwave fish in a shared office?", o:["Sure, it's just food","Only if there's good ventilation","Absolutely not — it's a war crime","Depends on the fish"] },
  { id:457, v:1, t:'m', c:'j', q:"Should you tip on an iPad checkout at a counter-service place?", o:["Always — workers deserve it","Only if service was great","No — it's guilt-tripping","I tip but resent the screen flip"] },
  { id:458, v:1, t:'b', c:'j', q:"Do you wash your legs in the shower, or does the soap running down count?" },
  { id:459, v:1, t:'m', c:'j', q:"The thumbs-up emoji (👍) in a text is:", o:["Friendly and efficient","Passive-aggressive","Depends on who sends it","I never use it"] },
  ...
  { id:463, v:1, t:'m', c:'j', q:"What's the correct way to eat a burrito?", o:["Handheld — no utensils allowed","Fork and knife is fine","Depends on structural integrity","Deconstruct and eat as a bowl"] },
  { id:464, v:1, t:'b', c:'j', q:"Is ketchup superior to mayo as a fry condiment?" },
  { id:465, v:1, t:'m', c:'j', q:"Red Sox vs Yankees — who has the better legacy?", o:["Red Sox — curse-breaking underdogs","Yankees — 27 rings speaks for itself","Neither — baseball is boring","I care deeply and will not elaborate"] },
  ...
  { id:484, v:1, t:'m', c:'j', q:"If animals could talk, which would be the rudest?", o:["Cats — obviously","Geese — already aggressive","Raccoons — chaotic energy","Seagulls — no remorse"] },
