...
(function () {
  ...
  var ASSESS_TESTS = {
    ...
    cognitive: {
      name: 'Cognitive Style', icon: '\u{1F9E9}', color: 'teal', scale: 'agreement',
      items: [
        { q: "I notice things others miss\u2014small sounds, subtle changes" },
    ...
    integrity: {
      name: 'Integrity Core', icon: '\u{1F48E}', color: 'emerald', scale: 'agreement',
